...
<head>
    ...
    <title>Cukur Men - The Premium Vibe</title>
...
<body>
    ...
    <header>
      <a href="#" class="logo">
        <img src="/assets/img/logo.png" alt="Logo Cukur Men">
        <div class="logo-text-container">
            <span class="cukur-text">CUKUR</span><span class="men-text">MEN</span>
        </div>
      </a>
        <nav>
            <ul class="nav-links" id="navLinks">
                ...
                <li class="nav-dropdown">
                    <button aria-haspopup="true" aria-expanded="false">Booking <i class="fas fa-caret-down"></i></button>
                    <ul class="dropdown-menu" aria-label="Booking menu">
                        <li><a href="/login">Book</a></li>
                        <li><a href="/login">Produk</a></li>
    ...
    <main>
        ...
        <section class="about-us" id="about-us">
            <div class="container">
                <h2>MENGAPA <span>CUKURMEN?</span></h2>
            ...
            <div class="container">
                ...
                <div class="produk-container">
                   ...
                   <div class="produk-card">
                        <img src="/assets/img/pom.jpg" alt="Cream Pomade Cukur Men"> 
    ...
    <footer class="new-footer">
        <div class="footer-grid">
            ...
            <div class="footer-links">
                <h4>COMPANY</h4>
                <ul>
                    <li><a href="landingpage.html#about-us">Tentang Kami</a></li>
                    <li><a href="landingpage.html#layanan">Layanan</a></li>
                    <li><a href="landingpage.html#barber">Barber</a></li>
                    <li><a href="landingpage.html#produk">Produk</a></li>
                </ul>
            </div>
            <div class="footer-links">
                <h4>OTHER</h4>
