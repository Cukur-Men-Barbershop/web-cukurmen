...
<div class="main-tab-content active" id="profil-tab-content">
    <div class="content-card">
        <h1 class="dashboard-header">Pengaturan <span>Profil</span> & Akun</h1>
        ...
        <div class="form-group">
            ...
            <span class="view-only-text" id="profilNamaBarbershop">{{ $namaBarbershop ?? 'CUKURMEN BARBERSHOP' }}</span>
        </div>
        <div class="form-group">
