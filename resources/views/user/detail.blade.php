            ...
            <div class="booking-summary">
                ...
                <div class="detail-section">
                    ...
                    <div class="detail-item">
                        ...
                        <span class="value" id="schedule-date">{{ \Carbon\Carbon::parse($booking->booking_date)->isoFormat('dddd, D MMMM Y') }}</span>
                    </div>
                     <div class="detail-item">
                ...
                <div class="detail-section total-payment">
                    <div class="detail-item">
                        ...
                        <span class="value price" id="total-price">Rp {{ number_format($booking->total_price, 0, ',', '.') }}</span>
                    </div>
                     <div class="detail-item">
                        <span class="label">Status Pembayaran:</span>
                        <span class="value payment-status" id="payment-status">{{ ucfirst($booking->payment_status) }}</span>
                    </div>
                </div>
            </div>
